...
するとこの発表をした1週間後にNano Banana Proという画像生成AIがGoogleから発表されました。
...
指示テキストを追加するだけでかなり想定する形に近いものが生成できています。プロンプトを改良すると生成結果にちゃんと反映されていくのを実験の過程で体感しており、明示的に好みの形に改良できる点が2つ目のアプローチより良い点だと感じています。
